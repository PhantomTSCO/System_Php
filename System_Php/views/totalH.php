	  		...
	  		try {
				...
				elseif(empty($_POST['lastN'])){
					...
					$res;
	  				...
	  				$res=Conexion::getTH($name,$lasN,$date,$date2);
	  				$resT=0;
	  				if ($res>0) {
	  					$resT=$res;
	  				}
...
<body>
	<header>
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
		      <div class="navbar-nav">
		        ...
		        <a class="nav-link active" aria-current="page" href="totalH.php">Calcular Horas</a>
		...
		<div class="container-lg">
			<p class="text-xl-start"><h1 align="center">Calcular Horas Trabajadas</h1></p>
			<form class="mx-5" action="totalH.php" method="post">
				<table class="table table-borderless">
					<tbody>
						<tr>
							...
							<th>
								<div class="mx-5 mb-3">
				<label class="mx-2">Horas</br>Trabajadas</label>
